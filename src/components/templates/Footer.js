                ...
                <Grid item py={2}>
                    <Box sx={{ mx: 'auto', maxWidth:500 }}>
                        <Grid container direction="row"  justifyContent="space-evenly">
                            ...
                            <Grid item><IconButton><AccountCircleRoundedIcon fontSize="large"/></IconButton></Grid>  {/* github blog */}
                            <Grid item><IconButton href="https://cheries-blog.onrender.com"><RssFeedRoundedIcon fontSize="large"/></IconButton></Grid>
                        </Grid>
                    </Box>
                </Grid>
